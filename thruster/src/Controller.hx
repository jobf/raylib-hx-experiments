...
class ControllerActions {
	...
	public var on_pressed_accelerate:Void->Void = () -> return;
	...
	public var on_released_accelerate:Void->Void = () -> return;
...
class Controller {
	...
	function pressed_accelerate() {
		trace("press ACCELERATE");
		actions.on_pressed_accelerate();
	}

	function released_accelerate() {
		trace("release ACCELERATE");
		actions.on_released_accelerate();
	}
}
